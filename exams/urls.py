...
urlpatterns = [
    ...
    path("groups/<int:group_id>/update/", views.teacher_update_group, name="teacher_update_group"),
    path("groups/<int:group_id>/delete/", views.teacher_delete_group, name="teacher_delete_group"),

    # ==========================
    # SLUG - Teacher Attempts (spesifik)
    # ==========================
    path("<slug:slug>/attempt/<int:attempt_id>/check/", views.teacher_check_attempt, name="teacher_check_attempt"),
    path("<slug:slug>/attempt/<int:attempt_id>/view/", views.teacher_view_attempt, name="teacher_view_attempt"),

    # ==========================
    # SLUG - Student Taking Exam (spesifik)
    # ==========================
    path("<slug:slug>/start/", views.start_exam, name="start_exam"),
    path("<slug:slug>/attempt/<int:attempt_id>/result/", views.exam_result, name="exam_result"),
    ...
    path("<slug:slug>/create-bank/", views.create_question_bank, name="create_question_bank"),
    path("<slug:slug>/process-bank/", views.process_question_bank, name="process_question_bank"),

    # ==========================
    # SLUG - Teacher Questions
    # ==========================
    path("<slug:slug>/add-question/", views.add_exam_question, name="add_exam_question"),
    path("<slug:slug>/questions/<int:question_id>/edit/", views.edit_exam_question, name="edit_exam_question"),
    path("<slug:slug>/questions/<int:question_id>/delete/", views.delete_exam_question, name="delete_exam_question"),

    # ==========================
    # SLUG - Teacher Exam Ops
    # ==========================
    path("<slug:slug>/results/", views.teacher_exam_results, name="teacher_exam_results"),
    path("<slug:slug>/toggle-active/", views.toggle_exam_active, name="toggle_exam_active"),
