"""RLS policy for the journal-correction table (üzrlü qayıb / sənədli düzəliş).

``registrar_journalcorrection`` has a direct ``organization_id`` FK — same
tenant-isolation pattern as the other registrar RLS migrations
(0026_rls_kollokvium_window). No-op off-Postgres.
"""
...
_TABLES = ["registrar_journalcorrection"]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("registrar", "0027_alter_lessonmark_status_journalcorrection"),
    ]
