"""RLS policies for the registrar gradebook tables (U3 — elektron jurnal).

Same tenant-isolation pattern as 0002/0004: ``organization_id::text =
current_org_id`` USING + WITH CHECK, bypass escape hatch, NULL-org allowance.
No-op off-Postgres.
"""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("registrar", "0006_courseoffering_instructor_assessmentscheme_and_more"),
    ]
