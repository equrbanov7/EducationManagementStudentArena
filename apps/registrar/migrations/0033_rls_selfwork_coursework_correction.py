"""RLS policies for the self-work + course-work correction tables.

Both carry a direct ``organization_id`` FK — same tenant-isolation pattern as
0028_rls_journal_correction / 0031_rls_lesson_correction. No-op off-Postgres.
"""
...
_TABLES = ["registrar_selfworkcorrection", "registrar_courseworkcorrection"]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("registrar", "0032_courseworkcorrection_selfworkcorrection"),
    ]
