"""RLS policy for the journal-close notice table (RİM xəbərdarlığı).

Same tenant-isolation pattern as 0026_rls_kollokvium_window. No-op off-Postgres.
"""
...
_TABLES = ["registrar_journalclosenotice"]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("registrar", "0046_journal_close_notice"),
    ]
