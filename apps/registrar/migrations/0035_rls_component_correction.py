"""RLS policy for the component-score correction table (kollokvium K1/K2/K3).

Direct ``organization_id`` FK — same tenant-isolation pattern as
0033_rls_selfwork_coursework_correction. No-op off-Postgres.
"""
...
_TABLES = ["registrar_componentscorecorrection"]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("registrar", "0034_componentscorecorrection"),
    ]
