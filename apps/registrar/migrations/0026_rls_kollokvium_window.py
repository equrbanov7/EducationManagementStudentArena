"""RLS policies for the kollokvium-window tables (İmtahan Mərkəzi pəncərəsi).

Same tenant-isolation pattern as the other registrar RLS migrations
(0023_rls_journal_tables). No-op off-Postgres.
"""
...
_TABLES = ["registrar_kollokviumwindow", "registrar_kollokviumextragrant"]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("registrar", "0025_kollokviumwindow_kollokviumextragrant_and_more"),
    ]
