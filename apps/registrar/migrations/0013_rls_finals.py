"""RLS policies for the final-grade / resit tables (U3+).
...
_TABLES = ["registrar_finalgrade", "registrar_resitrecord"]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("registrar", "0012_assessmentscheme_min_final_exam_score_and_more"),
    ]
