"""RLS policies for the electronic-journal tables (U3 redesign — lesson/mark).

Same tenant-isolation pattern as 0002/0004/0007. The removed gradebook tables
(gradecomponent/componentscore) drop their policies together with the tables in
0008; ``registrar_assessmentscheme`` keeps its policy from 0007. No-op off-Postgres.
"""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("registrar", "0008_remove_gradecomponent_organization_and_more"),
    ]
