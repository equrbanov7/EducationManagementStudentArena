"""RLS policies for the assessment-component tables (U7.1).
...
_TABLES = ["registrar_assessmentcomponent", "registrar_componentscore"]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("registrar", "0015_assessmentcomponent_componentscore_and_more"),
    ]
