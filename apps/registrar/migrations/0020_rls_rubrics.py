"""RLS policies for the rubric tables (U22).
...
_TABLES = ["registrar_rubric", "registrar_rubriccriterion", "registrar_criterionscore"]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("registrar", "0019_rubric_assessmentcomponent_rubric_rubriccriterion_and_more"),
    ]
