"""RLS policies for the registrar enrollment tables (U2).

Same tenant-isolation pattern as 0002: ``organization_id::text = current_org_id``
USING + WITH CHECK, bypass escape hatch, NULL-org allowance. No-op off-Postgres.
"""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("registrar", "0003_courseoffering_enrollment_groupelectivechoice_and_more"),
    ]
