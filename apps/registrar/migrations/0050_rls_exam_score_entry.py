"""RLS policy for the manual exam-score entry ledger (İmtahan Mərkəzi).

Direct ``organization_id`` FK — same tenant-isolation pattern as
0035_rls_component_correction. No-op off-Postgres.
"""
...
_TABLES = ["registrar_examscoreentry"]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("registrar", "0049_exam_score_entry"),
    ]
