"""Müraciət cədvəlləri üçün RLS/FORCE RLS tenant izolyasiyası.

Yeddi cədvəlin hamısında BİRBAŞA ``organization_id`` sütunu var (sayğacda o həm
də ilkin açardır), ona görə eyni sadə siyasət tətbiq olunur — nümunə
``apps/syllabus/migrations/0002_rls_syllabus.py``. Postgres xaricində no-op.
"""
...
_TABLES = [
    "applications_applicationunit",
    "applications_applicationkind",
    "applications_applicationcounter",
    "applications_application",
    "applications_applicationevent",
    "applications_applicationwatch",
    "applications_applicationattachment",
]
