/* testQuestionBank.js — toplu sual iş sahəsi (workbench) — 1/2:
 * fayl seçimi/yaddaş, təmizlə/yadda saxla, sətir seçimi, filtr paneli.
 * 2026-09-21 bölgüsü (modul ölçü büdcəsi ≤ 550 sətir): fayl validasiyası,
 * submit-dən əvvəl mətn çıxarma, uzun submit qoruyucusu, FAB və avto-scroll
 * `testQuestionBank_upload.js`-dədir. Hər iki fayl DOMContentLoaded-də işləyir —
 * bu fayl ƏVVƏL yüklənir və `window.EMSTestQuestionBank` (clearFileState) +
 * `window.showWorkbenchError`-u 2-ci fayldan əvvəl qurur.
 */
document.addEventListener("DOMContentLoaded", function () {
    ...
    // 2-ci hissə (testQuestionBank_upload.js) üçün ad sahəsi — eyni fileKey/UI.
    window.EMSTestQuestionBank = window.EMSTestQuestionBank || {};
    window.EMSTestQuestionBank.clearFileState = clearFileState;
    window.EMSTestQuestionBank.fileKey = fileKey;
  });
