...
def build_profile_response(request):
    ...
    # "create-category" / "category-management" bölmələri `_sections.category_management`-ə çıxarılıb.
    if {"create-category", "category-management"} & set(allowed_sections) and active_section in {
        "create-category",
        "category-management",
    }:
        _cc = build_create_category_context(category_management_create_form)
        category_management_create_form = _cc["category_management_create_form"]
        category_management_create_parent_options = _cc["category_management_create_parent_options"]
        category_management_create_selected_parent_id = _cc["category_management_create_selected_parent_id"]

    if "category-management" in allowed_sections and active_section == "category-management":
        _cm = build_category_management_context(
            request,
            edit_form=category_management_edit_form,
            edit_item=category_management_edit_item,
            page_param=category_management_page_param,
        )
        category_management_search_query = _cm["category_management_search_query"]
        category_management_total_count = _cm["category_management_total_count"]
        category_management_filtered_count = _cm["category_management_filtered_count"]
        category_management_page = _cm["category_management_page"]
        category_management_pagination_query = _cm["category_management_pagination_query"]
        category_management_edit_form = _cm["category_management_edit_form"]
        category_management_edit_item = _cm["category_management_edit_item"]
        category_management_edit_parent_options = _cm["category_management_edit_parent_options"]
        category_management_edit_selected_parent_id = _cm["category_management_edit_selected_parent_id"]
