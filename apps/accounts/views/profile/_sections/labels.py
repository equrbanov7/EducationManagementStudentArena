...
def build_section_titles() -> dict:
    ...
    return {
        ...
        "lessons-log": pgettext_lazy("profile.sidebar", "Keçilmiş dərslər"),
        ...
        "student-intake": pgettext_lazy("profile.sidebar", "Tələbə əlavəsi (toplu)"),
        "teacher-intake": pgettext_lazy("profile.sidebar", "Müəllim əlavəsi (toplu)"),
        "registrar-catalog": pgettext_lazy("profile.sidebar", "Registrar (kataloq)"),
        ...
        "pending-post-approvals": pgettext_lazy("profile.sidebar", "Postların idarəetməsi"),
        ...
        "superadmin-org-features": pgettext_lazy("profile.sidebar", "Təşkilat özəllikləri"),
        ...
        "superadmin-org-inspector": pgettext_lazy("profile.sidebar", "Təşkilat məlumatları"),
        ...
        "workload-center": pgettext_lazy("profile.sidebar", "Dərs yükü mərkəzi"),
        "workload-visa": pgettext_lazy("profile.sidebar", "Yük vizası"),
        "workload-approval": pgettext_lazy("profile.sidebar", "Yük təsdiqi"),
        "workload-overview": pgettext_lazy("profile.sidebar", "Yük — ümumi baxış"),
