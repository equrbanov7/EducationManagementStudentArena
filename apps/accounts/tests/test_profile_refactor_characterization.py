...
EXPECTED_PROFILE_CONTEXT_KEYS = {
    "active_main_nav", "active_section", "active_section_title", "all_modules",
    "allowed_sections", "assignable_roles", "assigned_courses",
    "assigned_courses_count", "assigned_courses_search_query", "assigned_exams_count",
    "assigned_task_counts", "assigned_task_items", "assigned_tasks_active_filter",
    "assigned_tasks_count", "assigned_tasks_search_query", "can_approve_posts",
    "can_manage_blog", "can_manage_org", "can_multi_assign_group_teachers",
    "can_review_submissions", "can_view_blog", "can_view_owned_learning",
    "can_view_student_assignments", "category_management_create_form",
    "category_management_create_parent_options",
    "category_management_create_selected_parent_id", "category_management_edit_form",
    "category_management_edit_item", "category_management_edit_parent_options",
    "category_management_edit_selected_parent_id", "category_management_filtered_count",
    "category_management_page", "category_management_page_param",
    "category_management_pagination_query", "category_management_search_query",
    "category_management_total_count", "courses_count", "direct_profile_section",
    "direct_profile_section_template", "evaluated_review_available_groups",
    "evaluated_review_count", "evaluated_review_filter_group",
    "evaluated_review_filter_type", "evaluated_review_items", "evaluated_review_page_obj",
    "evaluated_review_pagination_query", "evaluated_review_search_query",
    "evaluated_review_submitted_order", "evaluated_review_total_count", "filter_status",
    "filter_type", "group_form", "group_students_pagination_query",
    "group_students_search_query", "groups_section_return_url", "in_app_notifications_page",
    "in_app_unread_count", "is_admin", "is_superadmin", "is_teacher",
    "manage_roles_section", "my_courses", "my_created_courses",
    "my_created_courses_count", "my_exams", "my_exams_count", "my_exams_filter_type",
    "my_exams_search_query", "my_result_counts", "my_result_items",
    "my_results_active_filter", "my_results_count", "my_results_page_obj",
    "my_results_page_param", "my_results_pagination_query", "my_results_search_query",
    "notif_filter", "notif_pagination_query", "notif_search_query",
    "notifications_unread_count", "organization_access_rows", "organizations",
    "pagination_query", "password_change_form", "pending_answer_counts",
    "pending_answer_items", "pending_answers_active_filter", "pending_answers_count",
    "pending_answers_search_query", "pending_post_approval_available_groups",
    "pending_post_approval_available_organizations", "pending_post_approval_count",
    "pending_post_approval_filter_group", "pending_post_approval_filter_organization",
    "pending_post_approval_filter_status", "pending_post_approval_items",
    "pending_post_approval_page_obj", "pending_post_approval_pagination_query",
    "pending_post_approval_search_query", "pending_post_approval_total_count",
    "pending_review_available_groups", "pending_review_count",
    "pending_review_filter_group", "pending_review_filter_status",
    "pending_review_filter_type", "pending_review_items", "pending_review_page_obj",
    "pending_review_pagination_query", "pending_review_search_query",
    "pending_review_submitted_order", "pending_review_total_count",
    "pending_student_invites", "pending_student_join_message",
    "pending_student_join_org_name", "pending_student_join_requests",
    "permission_editor_section", "post_category_root_options",
    "post_category_subcategory_options", "post_category_tree",
    "post_creation_requires_approval", "post_next_url", "posting_blocked",
    "posting_blocked_reason", "posts_count", "primary_user_role_label", "profile",
    "profile_base_url", "profiles", "publish_notification_targets", "review_items",
    "role_assignment_section", "role_capabilities", "roles", "search_query",
    "selected_group_students_count", "selected_group_students_filtered_count",
    "selected_group_students_page", "selected_role", "selected_teacher_group",
    "shortcut_sections", "statistics_course_page", "statistics_course_page_param",
    "statistics_course_pagination_query", "statistics_course_rows", "statistics_courses",
    "statistics_data", "statistics_filters", "statistics_group_page",
    "statistics_group_page_param", "statistics_group_pagination_query",
    "statistics_group_rows", "statistics_groups", "statistics_has_active_filters",
    "statistics_org_page", "statistics_org_page_param", "statistics_org_pagination_query",
    "statistics_org_rows", "statistics_organizations", "statistics_reset_url",
    "statistics_teacher_course_page", "statistics_teacher_course_page_param",
    "statistics_teacher_course_pagination_query", "statistics_teacher_course_rows",
    "statistics_teacher_page", "statistics_teacher_page_param",
    "statistics_teacher_pagination_query", "statistics_teacher_rows",
    "student_can_leave_org", "student_member_groups", "student_member_groups_count",
    "student_member_groups_more_count", "student_org_management_section",
    "student_org_request_section", "superadmin_ai_settings_section",
    "superadmin_org_features_section", "superadmin_organizations_section",
    "superadmin_pending_org_count", "superadmin_users_section", "teacher_groups",
    "teacher_groups_count", "teacher_groups_filtered_count", "teacher_groups_page",
    "teacher_groups_pagination_query", "teacher_groups_payload",
    "teacher_groups_search_query", "total_count", "user_posts", "user_roles",
}
...
class ProfileContextContractTest(TestCase):
    ...
    def test_superadmin_profile_context_complete(self):
        admin = User.objects.create_superuser(
            username="superadmin", email="sa@example.com", password="pw12345678"
        )
    ...
    def test_teacher_profile_context_complete(self):
        ...
        teacher = User.objects.create_user(
            username="charteacher", email="t@example.com", password="pw12345678"
        )
    ...
    def test_student_profile_context_complete(self):
        ...
        student = User.objects.create_user(
            username="charstudent", email="s@example.com", password="pw12345678"
        )
    ...
    def test_each_allowed_section_renders_200(self):
        ...
        admin = User.objects.create_superuser(
            username="sectionadmin", email="sec@example.com", password="pw12345678"
        )
        self.client.force_login(admin)
        ...
        for section in sorted(allowed):
            with self.subTest(section=section):
                ...
                self.assertEqual(
                    resp.status_code, 200, f"section '{section}' did not render 200"
                )
...
class ProfileSectionResolutionTest(TestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            username="sectionuser", email="su@example.com", password="pw12345678"
        )
...
class ProfilePostHandlingTest(TestCase):
    ...
    def test_edit_profile_rejects_duplicate_email(self):
        ...
        User.objects.create_user(
            username="other", email="taken@example.com", password="pw12345678"
        )
        resp = self.client.post(
            reverse("accounts:profile"),
            {
...
class ProfileAvatarViewTest(TestCase):
    ...
    def setUp(self):
        self.client = Client()
        self.user = User.objects.create_user(
            username="avataruser", email="av@example.com", password="pw12345678"
        )
...
class PublicProfileViewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.author = User.objects.create_user(
            username="publicauthor", email="pa@example.com", password="pw12345678"
        )
    ...
    def test_public_profile_unknown_user_404(self):
        resp = self.client.get(
            reverse("accounts:public_profile", kwargs={"username": "nobody-here"})
        )
        self.assertEqual(resp.status_code, 404)
    ...
    def test_public_profile_context_keys_present(self):
        ...
        expected = {
            "profile_user", "profile", "display_name", "search_query",
            "selected_category", "extra_query", "category_items",
            "published_posts_count", "category_count", "profile_bio",
            "profile_location", "posts",
        }
