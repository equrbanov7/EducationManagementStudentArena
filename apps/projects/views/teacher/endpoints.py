...
from ..shared._helpers import _get_tenant_project_or_404, _get_tenant_submission_or_404, _teacher_review_back_url
...
def review_submissions(request, pk):
    ...
    submissions = project.submissions.select_related("student", "project__course__organization")
