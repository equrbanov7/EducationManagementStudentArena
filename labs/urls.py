...
urlpatterns = [
    ...
    path('submissions/<int:pk>/grade-page/', views.grade_submission_page, name='grade_submission_page'),
    ...
    path('submissions/<int:pk>/answers/', views.submission_answers, name='submission_answers'),
]