...
* **Hələ açıq:** `NIGHT_WAVES_2026_09_14.md` §5 (kohort modelinin tam çıxarılması, `accounts_userprofile` RLS, bəzi infra P3-lər; pano ilə şəkil yapışdırma dalğa 8-də bağlandı) və §27 «MÜTLƏQ» sahib əməliyyatları (dəyişməyib).
