...
| Sahə | Dəyər |
|---|---|
| Hesabat vaxtı | 2026-09-06 20:40:28 |
| Mənbə (MariaDB) | `emsarena-legacy-source-rehearsal:myedudb` |
| Hədəf (PostgreSQL) | `127.0.0.1:55433/emsarena_rehearsal_43f4ed790519` |
| Repetisiya rejimi / statusu | `rehearsal` / `succeeded` |
| Snapshot SHA-256 | `177ef2269027395f…` |
| Ledger-in gördüyü mənbə sətri | 15,496 |
| Başlama → bitmə | 2026-09-06 01:13:04.966984+00:00 → 2026-09-06 07:45:29.983921+00:00 |
...
Ümumi sorğu vaxtı: **13 dəq 34 s** (43 sorğu, hamısı yalnız-oxu).

| Sorğu | Müddət | Qaytarılan sətir |
|---|---|---|
| hədəf · immutable bal-vərəqi artifact-ləri | 10 dəq 34 s | 52,386 |
| mənbə · dedup edilmiş xana açarları | 1 dəq 29 s | 5,134,834 |
| mənbə · xana seçki açarları | 19.4 s | 5,150,028 |
| mənbə · xana təsnifatı | 10.7 s | 17 |
| mənbə · dəyər paylanması | 7.8 s | 18 |
| hədəf · keyfiyyət | 7.7 s | 13 |
| hədəf · nümunə yazılışlar | 6.3 s | 219 |
| mənbə · bal-vərəqi artifact metadata | 6.0 s | 52,386 |
| hədəf · immutable legacy qiymət faktları | 5.6 s | 171,080 |
| mənbə · xam yazıla bilən | 4.8 s | 3 |
| hədəf · varlıq sayları | 4.5 s | 29 |
| hədəf · ledger | 2.7 s | 55 |
| mənbə · journals_dates_points xam source hash | 2.2 s | 136,888 |
| mənbə · legacy qiymət faktları | 2.2 s | 169,231 |
| hədəf · yekun güzgüsü | 1.7 s | 14,668 |
| mənbə · mənbə dərs slotları | 1.7 s | 309,551 |
| mənbə · cədvəl sayları | 1.1 s | 15 |
| hədəf · bərpa dərslərindəki xanalar | 708 ms | 1 |
| hədəf · enrollment körpüsü | 623 ms | 183,771 |
| hədəf · dərs slotları | 608 ms | 304,805 |
